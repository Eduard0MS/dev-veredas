<x-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600 dark:text-gray-400">
            {{ __('Caso necessário, você pode encerrar todas as demais sessões do navegador em todos os seus dispositivos. Abaixo, listamos algumas de suas sessões recentes, embora essa lista possa não ser completa. Se suspeitar que sua conta foi comprometida, recomendamos que você atualize sua senha imediatamente.') }}
        </div>
